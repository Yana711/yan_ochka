#include "human_2.cpp"
#include "monster_2.cpp"
#include <fstream> /*a thing that allows you to read from a file and write to it*/
#include <sstream> /*a thing that allows you to work with strings as with streams.*/
using namespace std;

string triel(People* human, Wizard* wiz, Monster* monst, Book* book)
{/*the thing that will track the continuation of the battle*/
    bool flag = 0;
    while(flag == 0)
    {   
        if(human->health>0)
...
main() {
    ...
    {   
        ...
        {
            cout << "I feel sorry for this kind man...\n";
        }
    }
