...
#include <vector>
#include <memory>
#ifndef whiskey /*Since the aang class is the parent for all other wars, this code can be compiled several times to prevent this, we define "whiskey", then if "whiskey" is already defined, the code will not compile again*/
#define whiskey
using namespace std;

/*I will not comment on this file further, since I have already told everything on the defense. I just translated the signatures from Russian into English.*/
...
public:
    ...
    void apply(Aang* aang) {
        cout << "A household spell is not intended for combat.\n";
    }
};
...
public:
    ...
    void apply(Aang* aang) {
        cout << "It's not worth using this spell.\n";
    }
};
...
/*The thing that creates the spell book*/
